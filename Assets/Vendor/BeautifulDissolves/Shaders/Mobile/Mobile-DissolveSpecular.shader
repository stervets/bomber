Shader "Beautiful Dissolves/Mobile/Dissolve (Specular Setup)" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf MobileBlinnPhong exclude_path:prepass keepalpha nolightmap noforwardadd halfasview interpolateview
		...
		#include "./../Includes/DissolveMobileFunctions.cginc"
