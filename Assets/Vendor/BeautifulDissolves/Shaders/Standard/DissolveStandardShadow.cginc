...
#ifndef DISSOLVE_STANDARD_SHADOW_INCLUDED
#define DISSOLVE_STANDARD_SHADOW_INCLUDED
...
#if defined(_ALPHATEST_ON) || defined(_ALPHABLEND_ON) || defined(_ALPHAPREMULTIPLY_ON) || defined(_DISSOLVEMAP)
    ...
    ) : SV_Target
{
        ...
        #endif
        #ifndef _SUBMAP
			float2 adjustedUV = GetAdjustedUV(i.tex);
			half d = tex2D(_DissolveMap, adjustedUV).r;
			DirectionMapFactor(d, adjustedUV);
			d -= _DissolveAmount;
			clip(d);
		#endif
...
#endif // DISSOLVE_STANDARD_SHADOW_INCLUDED
