...
#ifndef DISSOLVE_STANDARD_META_INCLUDED
#define DISSOLVE_STANDARD_META_INCLUDED

// Functionality for Standard Dissolve shader "meta" pass
...
float4 frag_meta (v2f_meta i) : SV_Target
{
	...
	half3 emis = Emission(i.uv.xy);

	#if SHADER_TARGET >= 30
		emis = DissolveEmission(emis, i.uv.xy, data.diffColor);
	#endif
...
#endif // DISSOLVE_STANDARD_META_INCLUDED
