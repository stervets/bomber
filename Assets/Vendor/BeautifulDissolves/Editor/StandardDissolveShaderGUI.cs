...
namespace UnityEditor
{
	internal class StandardDissolveShaderGUI : ShaderGUI
	{
		...
		static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
		{
			...
			bool shouldEmissionBeEnabled = ShouldEmissionBeEnabled (material, material.GetColor("_EmissionColor")) || material.IsKeywordEnabled("_DISSOLVEGLOW_ON") || material.IsKeywordEnabled("_EDGEGLOW_ON");
